 ...
 * 
 * @param <T> This type parameter specifies the type of timer data objects which
...
public interface Timeable<T> {
  ...
  /**
   * Receives a timed event callback from the reactor. This method is executed by
   * the reactor in response to a timed event. Depending on context, this may
   * either be a one-shot event or repeated at intervals.
   * 
   * @param data This is the timer data object which was associated with the timed
